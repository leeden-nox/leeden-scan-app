    ...
    <>
      <BrowserRouter>
        <Switch>
          ...
          <Route exact path={PathLink.login}>
            <LoginPage />
          </Route>
          ...
          <Route
            exact
            path={PathLink.pickListQtyDetail}
            component={PickListQtyDetail}
          />
          <Route
            exact
            path={PathLink.pickListQtyDetailPick}
            component={PickListQtyDetailPick}
          />

          {/* Flowmeter Reading */}
          <Route
            exact
            path={PathLink.flowmeterReading}
            component={FlowmeterReading}
          />
          <Route
            exact
            path={PathLink.flowmeterReadingDetail}
            component={FlowmeterReadingDetail}
          />
          ...
          <Route
            exact
            path={PathLink.onSiteVerificationDetail}
            component={OnSiteVerificationDetail}
          />
          <Route
            exact
            path={PathLink.onSiteVerificationDetailSerial}
            component={OnSiteVerificationDetailSerial}
          />

          {/* Cust Site Verification */}
          <Route
            exact
            path={PathLink.custSiteVerification}
            component={CustSiteVerification}
          />
          <Route
            exact
            path={PathLink.custSiteVerificationAccountCode}
            component={CustSiteVerificationAccountCode}
          />
          <Route
            exact
            path={PathLink.custSiteVerificationDetail}
            component={CustSiteVerificationDetail}
          />
          <Route
            exact
            path={PathLink.custSiteVerificationDetailSerial}
            component={CustSiteVerificationDetailSerial}
          />
          {/* User Access */}
          ...
          <Route
            exact
            path={PathLink.driverEcrDetail}
            component={DriverECRDetail}
          />
          {/* ECR */}
          ...
          <Route
            exact
            path={PathLink.processingGRPO}
            component={ProcessingGRPO}
          />
          ...
          <Route
            exact
            path={PathLink.hpRefillingDetail}
            component={HPRefillingDetail}
          />

          {/* Pending Assign Pick List */}
          <Route
            exact
            path={PathLink.pendingAssignPickList}
            component={PendingAssignPickList}
          />
          <Route
            exact
            path={PathLink.pendingAssignPickListDetail}
            component={PendingAssignPickListDetail}
          />
          <Route
            exact
            path={PathLink.assignedPickList}
            component={AssignedPickList}
          />

          {/* Query Inventory */}
          <Route
            exact
            path={PathLink.queryInventory}
            component={QueryInventory}
          />
          <Route
            exact
            path={PathLink.queryInventoryDetail}
          ...
          <Route
            exact
            path={PathLink.COPContainerSearch}
